...
1. `pod repo`下发现github上的地址没有了，可能某些情况不小心删除了

2. 移除为空的repo  我这里是master
``` obj
pod repo remove master  #【github对应的地址是谁移除谁】
```

3. 重新添加下地址【我不移除，添加不了，所以就移除了，如果能修改更好】
``` obj
